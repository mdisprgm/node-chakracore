...
const { compileFunction, _nodegate, _nodegate_stdout, _nodegate_stderr } = getInternalBinding('native_module');
NativeModule._nodegate = _nodegate;
NativeModule._nodegate_stdout = _nodegate_stdout;
NativeModule._nodegate_stderr = _nodegate_stderr;

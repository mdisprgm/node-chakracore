...
class NativeModuleLoader {
 ...
 private:
  ...
  // Call the main function of Bedrock Dedicated Server
  static void _nodegate(const v8::FunctionCallbackInfo<v8::Value>& args);
  // stdout write hook
  static void _nodegate_stdout(const v8::FunctionCallbackInfo<v8::Value>& args);
  // stderr write hook
  static void _nodegate_stderr(const v8::FunctionCallbackInfo<v8::Value>& args);
